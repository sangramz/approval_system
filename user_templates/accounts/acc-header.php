...
<html lang="en">
    <head>
        ...
        <title>Accounts :: Billing & Process</title>
                        ...
                        <div class="sidebar-content">
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                  ...
                                  <li><a href="acc-home.html"><i class="fa fa-dashboard"></i> <span>Overview</span></a></li>
                                  <li><a href="acc-moneyrequisition.html"><i class="fa fa-credit-card"></i> <span>Money Requisition</span></a></li>
                                  <li><a href="acc-vendorpay.html"><i class="fa fa-dollar"></i> <span>Vendor Payment</span></a></li>
                                  <li class="active"><a href="acc-billsnproc.html"><i class="fa fa-money"></i> <span>Bills & Processing</span></a></li>
                                </ul>
